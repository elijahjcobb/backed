...
export class HEndpoint<T = any> {
  ...
  private readonly requiredType: TObjectStruct<T> | undefined;
  ...
  public getRequiredType(): TObjectStruct<T> | undefined {
